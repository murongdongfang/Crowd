...
import com.whpu.crowd.entity.po.ProjectItemPicPO;
import com.whpu.crowd.entity.po.ProjectItemPicPOExample;
...
public interface ProjectItemPicPOMapper {
    ...
    int insertPathList(@Param("projectId") Integer projectId, @Param("detailPicturePathList") List<String> detailPicturePathList);
}